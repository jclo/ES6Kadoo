...
// -- Local Modules
const ES6Kadoo = require('../src/pseudoclassical').default
    ;
...
describe('Test ES6Kadoo:', () => {
  ...
  describe('Test ES6Kadoo constructor and methods:', () => {
    const o = new ES6Kadoo('name');

    it('Expects new ES6Kadoo("name") to return an object.', () => {
