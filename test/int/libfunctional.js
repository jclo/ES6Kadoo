...
module.exports = function(ES6Kadoo, libname, version) {
  describe('ES6Kadoo introspection:', () => {
    ...
    describe('Test ES6Kadoo constructor:', () => {
      ...
      it(`Expects ES6Kadoo object to own ${2 + OWNPROPS} properties.`, () => {
      ...
      describe('Check the owned generic properties:', () => {
        ...
        it('Expects ES6Kadoo object to own the property "whoami" that is a function.', () => {
        ...
        describe('Check the owned specific properties:', () => {
          it('Expects ES6Kadoo object to own the property "getString" that is a function.', () => {
            expect(o).to.own.property('getString').that.is.a('function');
          });

          it('Expects ES6Kadoo object to own the property "getArray" that is a function.', () => {
