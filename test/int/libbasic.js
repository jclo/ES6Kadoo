...
module.exports = function(ES6Kadoo, libname, version) {
  describe('ES6Kadoo introspection:', () => {
    describe('Test the nature of ES6Kadoo:', () => {
      it('Expects ES6Kadoo to be an object.', () => {
        expect(ES6Kadoo).to.be.an('object');
      });

      it(`Expects ES6Kadoo to own ${6 + OWNPROPS} properties.`, () => {
        expect(Object.keys(ES6Kadoo)).to.be.an('array').that.has.lengthOf(6 + OWNPROPS);
      });
    });
    ...
    describe('Check the owned generic properties:', () => {
      ...
      it('Expects ES6Kadoo to own the property "_library" that is an object.', () => {
        expect(ES6Kadoo).to.own.property('_library').that.is.an('object');
      });
      ...
      it('Expects ES6Kadoo to own the property "whoami" that is a function.', () => {
      ...
      describe('Test the owned generic properties:', () => {
        it('Expects the property "_library" to own two properties.', () => {
          expect(Object.keys(ES6Kadoo._library)).to.be.an('array').that.has.lengthOf(2);
        });
        it(`Expects the property "_library" to own the property "name" whose value is "${libname}".`, () => {
          expect(ES6Kadoo._library).to.own.property('name').that.is.equal(libname);
        });
        it(`Expects the property "_library" to own the property "version" whose value is "${version}".`, () => {
          expect(ES6Kadoo._library).to.own.property('version').that.is.equal(version);
        });
    ...
    describe('Check the owned specific properties:', () => {
      it('Expects ES6Kadoo to own the property "getString" that is a function.', () => {
        expect(ES6Kadoo).to.own.property('getString').that.is.a('function');
      });

      it('Expects ES6Kadoo to own the property "getArray" that is a function.', () => {
