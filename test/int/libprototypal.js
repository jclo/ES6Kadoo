...
// -- Main
module.exports = function(ES6Kadoo, libname, version, type) {
  describe('ES6Kadoo introspection:', () => {
    describe('Test the nature of ES6Kadoo:', () => {
      it('Expects ES6Kadoo to be a function.', () => {
        expect(ES6Kadoo).to.be.a('function');
      });

      it(`Expects ES6Kadoo to own ${4 + LIBPROPS} custom properties.`, () => {
        expect(Object.keys(ES6Kadoo)).to.be.an('array').that.has.lengthOf(4 + LIBPROPS);
      });
      ...
      describe('Check the owned generic custom properties:', () => {
        it(`Expects ES6Kadoo to own the property "NAME" whose value is "${libname}".`, () => {
          expect(ES6Kadoo).to.own.property('NAME').that.is.equal(libname);
        });

        it(`Expects ES6Kadoo to own the property "VERSION" whose value is "${version}".`, () => {
          expect(ES6Kadoo).to.own.property('VERSION');
        });

        it('Expects ES6Kadoo to own the property "_setTestMode" that is a function.', () => {
          expect(ES6Kadoo).to.own.property('_setTestMode').that.is.a('function');
        });

        it('Expects ES6Kadoo to own the property "noConflict" that is a function.', () => {
        ...
        describe('Test the owned generic custom properties:', () => {
          it(`Expects the property "_setTestMode" to return an array with ${TESTMODE} item(s).`, () => {
            expect(ES6Kadoo._setTestMode()).to.be.an('array').that.has.lengthOf(TESTMODE);
          });
        ...
        describe('Check the owned specific custom properties:', () => {
          it('Expects ES6Kadoo to own the property ... to be completed or ... removed!', () => {
            expect(true).to.be.equal(true);
          });

          describe('Test the owned specific custom properties:', () => {
            it('Expects ES6Kadoo the property ... to be completed or ... removed!', () => {
              expect(true).to.be.equal(true);
            });
          });
        });
    ...
    describe('Test ES6Kadoo constructor:', () => {
      if (type === 'with new') {
      ...
      const o = type === 'with new' ? new ES6Kadoo() : ES6Kadoo();
      const op = Object.getOwnPropertyNames(o);
      const io = Object.keys(Object.getPrototypeOf(o));

      it('Expects the function ES6Kadoo to return an object.', () => {
        expect(o).to.be.an('object');
      });

      it(`Expects ES6Kadoo object to own ${1 + OWNPROPS} property(ies).`, () => {
      ...
      describe('Check the owned generic properties:', () => {
        it('Expects ES6Kadoo object to own the property "_library" that is an object.', () => {
      ...
      describe('Check the inherited generic properties:', () => {
        it(`Expects ES6Kadoo object to inherit ${1 + INHPROPS} property(ies).`, () => {
          expect(io).to.be.an('array').that.has.lengthOf(1 + INHPROPS);
        });

        it('Expects ES6Kadoo object to inherit the property "whoami" that is a function.', () => {
      ...
      describe('Check the inherited specific properties:', () => {
        it('Expects ES6Kadoo object to inherit the property "getString" that is a function.', () => {
          expect(o).to.have.property('getString').that.is.a('function');
        });

        it('Expects ES6Kadoo object to inherit the property "getArray" that is a function.', () => {
