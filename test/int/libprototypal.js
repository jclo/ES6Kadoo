...
module.exports = function(ES6Kadoo, libname, version) {
  describe('ES6Kadoo introspection:', () => {
    describe('Test the nature of ES6Kadoo:', () => {
      ...
      it('Expects ES6Kadoo to own 4 custom properties.', () => {
        expect(Object.keys(ES6Kadoo)).to.be.an('array').that.has.lengthOf(4);
      });
    ...
    describe('Test ES6Kadoo constructor:', () => {
      ...
      it('Expects ES6Kadoo object to own 1 property.', () => {
        expect(op).to.be.an('array').that.has.lengthOf(1);
      });

      it('Expects ES6Kadoo object to inherit 3 properties.', () => {
